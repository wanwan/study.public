...
typedef struct _EFI_BOOT_SERVICES {
    ...
    void *RaiseTPL; /* not implemted yet */
    void *RestoreTPL; /* not implemted yet */
    ...
    void *AllocatePages; /* not implemted yet */
    void *FreePages; /* not implemted yet */ 
    void *GetMemoryMap; /* not implemted yet */
    void *AllocatePool; /* not implemted yet */
    void *FreePool; /* not implemted yet */
    ...
    void *CreateEvent; /* not implemted yet */
    void *SetTimer; /* not implemted yet */
    EFI_WAIT_FOR_EVENT WaitForEvent; 
    void *SignalEvent; /* not implemted yet */
    void *CloseEvent; /* not implemted yet */
    void *CheckEvent; /* not implemted yet */
...
typedef struct _EFI_SYSTEM_TABLE {
    ...
    EFI_BOOT_SERVICES *BootServices;    /* TODO: not support yet */
